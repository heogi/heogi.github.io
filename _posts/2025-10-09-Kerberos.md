...
1. AS_REQ (request TGT)
	...
	2. Client Name, Pre-Auth Data(Client Key로 암호화된 Timestamp)를 KDC에 전송
2. AS_REP (receive TGT)
	1. KDC의 DB에서 사용자의 Client Key를 사용하여 Pre-Auth Data를 복호화하여 Timestamp 유효성 검증
	2. krbtgt 계정의 키로 암호화된 TGT(Ticket Granting Ticket) 전달

![](../heogi.github.io/assets/img/2025-10-09-Kerberos-1760189042362.png)